...
class UpdateChecker:
    ...
    def __init__(self, local_version_file=None, remote_version_url=None):
        ...
        self.remote_version_url = remote_version_url or "https://raw.githubusercontent.com/shin315/social-download-manager/main/version.json"
    ...
    def _get_current_version(self):
        ...
        try:
            ...
            return "1.2.1"  # Default fallback version
